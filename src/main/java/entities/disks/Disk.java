...
@Document("disks")
public class Disk {//створення класу Disk
    @Id
    private String name;
    private double price;
    private List<Track> tracks;//створення списку треків

    public Disk(String name, double price, List<Track> tracks) {//конструктор класу Disk
        this.name = name;
        this.price = price;
        this.tracks = tracks;
    }
